...
public class Query8 {
	public static void main(String[] args) throws Exception {
		...
		DataSet<SolutionMapping> sm1 = dataset
			.filter(new T2T_FF(null, "http://www4.wiwiss.fu-berlin.de/bizer/bsbm/v01/vocabulary/reviewFor", "http://www4.wiwiss.fu-berlin.de/bizer/bsbm/v01/instances/dataFromProducer1/Product42"))
		...
		DataSet<SolutionMapping> sm21 = sm20
			.map(new SM2SM_PF(new String[]{"?title", "?reviewDate", "?reviewer", "?reviewerName", "?rating1", "?rating2", "?rating3", "?rating4"}));

		DataSet<SolutionMapping> sm22 = sm21
			.first(20);

		//************ Sink  ************
		sm22.writeAsText("./Query8-Flink-Result", FileSystem.WriteMode.OVERWRITE)
			.setParallelism(1);
